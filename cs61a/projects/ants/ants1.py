...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        if self.effect_tracker:
            self.effect_action(colony)
            self.effect_tracker -= 1
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self, armor=1):
        ...
        # END Problem 13
    def double_dooey(self,dis_ant):
        if dis_ant and dis_ant.name is not 'Queen' and dis_ant not in self.buff_boiz:
                dis_ant.damage *= 2
                self.buff_boiz.append(dis_ant)
                if dis_ant.is_container and dis_ant.contained_ant:
                    QueenAnt.double_dooey(self,dis_ant.contained_ant)
    ...
    def action(self, colony):
        ...
        if self.queen_or_nah:
            ...
            while self.place.exit:
                QueenAnt.double_dooey(self,self.place.ant)
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    if bee.effect_tracker == False:
        bee.effect_tracker = duration
        effect_action = effect(bee.action,bee)
    # END Problem EC
