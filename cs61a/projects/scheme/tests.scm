...
(begin (define (x a) (define x a)) (cons x '(y z)))
;expect ((lambda (a) (define x a)) y z)

; 'PROBLEM-9'
(define a (lambda (a b c) (* a b c)))
;expect a
...
;Problem 10
(define (func) (define (foo) (/ 1 0)))
;expect func

func
;expect (lambda () (define (foo) (/ 1 0)))
